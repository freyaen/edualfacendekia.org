...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('admins.update', $admin->uuid) }}" id="admin-form">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                    ...
                                    <select class="form-control @error('store_uuid') is-invalid @enderror" 
                                        ...
                                        @foreach ($data['stores'] as $store)
                                            <option value="{{ $store->uuid }}" 
                                                {{ old('store_uuid', $admin->store_uuid) == $store->uuid ? 'selected' : '' }}>
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ route('admins') }}" class="btn btn-light">Batal</a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    document.getElementById('btn-submit').addEventListener('click', function () {
        Swal.fire({
            ...
            text: "Perubahan data admin akan disimpan.",
            icon: 'warning',
