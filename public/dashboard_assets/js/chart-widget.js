(function ($) {
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: RihoAdminConfig.primary,
          label: {
            borderColor: RihoAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: RihoAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    series: [
      ...
      {
        name: "Bubble2",
        data: generateData(new Date("12 Feb 2024 GMT").getTime(), 20, {
          min: 10,
          max: 60,
        }),
      },
      {
        name: "Bubble3",
        data: generateData(new Date("26 Feb 2024 GMT").getTime(), 20, {
          min: 10,
          max: 60,
        }),
      },
      {
        name: "Bubble4",
        data: generateData(new Date("01 Feb 2024 GMT").getTime(), 20, {
          min: 10,
          max: 60,
        }),
      },
  ...
  var optionsCircle = {
    ...
    colors: [RihoAdminConfig.secondary, RihoAdminConfig.primary, "#51bb25"],
    responsive: [{
      breakpoint: 767,
      options: {
        title: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [RihoAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [RihoAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [RihoAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
    ...
    fill: {
      ...
      gradient: {
        inverseColors: false,
        gradientToColors: [RihoAdminConfig.secondary],
      },
    },
    responsive: [{
      breakpoint: 767,
